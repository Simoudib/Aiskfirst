...
const WHATSAPP_NUMBER = '18149567463'
    ...
    <div className="success-root">
      ...
      <div className="success-card">
        ...
        <p className="success-subtitle">
          Your unique access code is ready. Send it to our WhatsApp to activate your subscription.
        </p>

        {/* Code display */}
        <div className="success-code-section">
          <p className="success-code-label">Your Access Code</p>
          {code ? (
            ...
            <div className="success-code-box success-code-box--error">
              <span className="success-code-text" style={{ fontSize: '0.85rem', color: '#f87171' }}>
                Could not load code. Please contact support.
              </span>
            </div>
          ) : (
        ...
        <div className="success-instructions">
          <div className="success-step">
            ...
            <p className="success-step-text">Copy your unique code above</p>
          </div>
          <div className="success-step-arrow">→</div>
          <div className="success-step">
            <div className="success-step-num">2</div>
            <p className="success-step-text">Send it to our WhatsApp</p>
          </div>
          <div className="success-step-arrow">→</div>
          <div className="success-step">
            <div className="success-step-num">3</div>
            <p className="success-step-text">We activate your access</p>
          </div>
        </div>

        {/* WhatsApp CTA */}
        <div className="success-wa-section">
          <p className="success-wa-label">Send your code to</p>
        ...
        <a href="/" className="success-home-link">← Back to home</a>
      </div>
